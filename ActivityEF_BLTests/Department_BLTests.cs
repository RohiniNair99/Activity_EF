...
namespace ActivityEF_BL.Tests
{
    ...
    public class Department_BLTests
    {
        ...
        {
            DateTime date = DateTime.ParseExact("12/03/2012", "dd/MM/yyyy", null);
            ...
            Department_BL bl = new Department_BL();
            var expected = obj.Name;
            var actual= bl.DepartmentInputValues(1, "Engineering", "Research and Development", date).Name;
        ...
        public void NDepartmentInputValuesTest()
        {
            ...
            Department_BL bl = new Department_BL();
            var expected = obj.Name;
            var actual = bl.DepartmentInputValues(1, "Human Resource", "Research and Development", date).Name;
